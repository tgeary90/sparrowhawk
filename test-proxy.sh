...
docker run -it --name proxy-test --link local-server -p 8091:8091 -v ${PWD}/images/test_node/content:/content test-node /bin/bash -c 'node /content/e2e_tests/sparrowproxy.js'
